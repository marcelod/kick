<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">Company Admin</a>
    </div>
    <!-- /.navbar-header -->
       ...
       <!--  <li class="dropdown">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                <li>
                    <?php echo anchor("#", '<i class="fa fa-user fa-fw"></i> Editar perfil'); ?>
                </li>
            ...
            <ul class="nav" id="side-menu">
                ...
                <?php if (ENVIRONMENT === 'development'): ?>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <?php echo anchor('ui_elements/panels_wells', 'Panels and Wells'); ?>
                            </li>
                            <li>
                                <?php echo anchor('ui_elements/buttons', 'Buttons'); ?>
                            </li>
                            <li>
                                <?php echo anchor('ui_elements/notifications', 'Notifications'); ?>
                            </li>
                            <li>
                                <?php echo anchor('ui_elements/typography', 'Typography'); ?>
                            </li>
                            <li>
                                <?php echo anchor('ui_elements/icons', 'Icons'); ?>
                            </li>
                            <li>
                                <?php echo anchor('ui_elements/grid', 'Grid'); ?>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
